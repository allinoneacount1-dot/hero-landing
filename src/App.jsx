...
function App() {
  ...
  const headingWords = "Build Strong, Build Smart".split(" ");
  const subWords =
    "High-quality construction materials for every project, from foundation to finish.".split(
      " "
    );
          ...
          <div className="text-center max-w-4xl">
            <h1 className="text-[62px] font-bold leading-tight mb-6">
              {headingWords.map((word, i) => (
                <span
                  key={i}
                  className="inline-block mr-3 word-anim"
            ...
            <p className="text-[15px] font-light text-white/80 max-w-[480px] mx-auto mb-10">
              {subWords.map((word, i) => (
                <span
                  key={i}
                  className="inline-block mr-[0.25em] word-anim"
