...
import { Twitter, Menu, X, ArrowLeft } from "lucide-react";
      ...
      <div className="relative z-20 flex flex-col min-h-screen">
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-12">
          <div className="text-center max-w-lg">
            <p className="text-[120px] font-bold leading-none tracking-tighter text-white/10">404</p>
            <h1 className="text-2xl font-bold mt-4">Page not found</h1>
            <p className="text-sm text-white/50 mt-2">The page you're looking for doesn't exist or has been moved.</p>
            <Link
              to="/dashboard"
              className="inline-flex items-center gap-2 mt-6 px-5 py-2 bg-white text-black text-sm font-medium hover:bg-white/90 transition-colors"
            >
